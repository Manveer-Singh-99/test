...
function setup() {
 ...
 //oneStar = createSprite(570,300,10,10);
 //oneStar.addImage(oneStarImg);
 //oneStar.scale = 0.05;

 //twoStar = createSprite(520,300,10,10);
 //twoStar.addImage(twoStarImg)
 //twoStar.scale = 0.05;

 //threeStar = createSprite(50,30,10,10);
 //threeStar.addImage(threeStarImg)
 //threeStar.scale = 0.14;

 //fourStar = createSprite(80,30,10,10);
 //fourStar.addImage(fourStarImg)
 //fourStar.scale = 0.08;

 //fiveStar = createSprite(120,30,10,10);
 //fiveStar.addImage(fiveStarImg)
 //fiveStar.scale = 0.13;

 //sixStar = createSprite(140,30,10,10);
 //sixStar.addImage(sixStarImg)
 //sixStar.scale = 0.13;

 //sevenStar = createSprite(160,30,10,10);
 //sevenStar.addImage(sevenStarImg)
 //sevenStar.scale = 0.17;
